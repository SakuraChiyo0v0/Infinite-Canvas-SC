(function(){
    ...
    window.StudioI18n.register({
        ...
        "common.comfyuiSettings": { zh: "本地模型（可选）", en: "Local Models (Optional)" },
        "common.darkMode": { zh: "黑夜模式", en: "Dark Mode" },
        "common.lightMode": { zh: "白天模式", en: "Light Mode" },
        "common.appearance": { zh: "外观", en: "Theme" },
        "common.languageLabel": { zh: "语言", en: "Language" },
        ...
        "nav.localTools": { zh: "图像工具", en: "Image tools" },
